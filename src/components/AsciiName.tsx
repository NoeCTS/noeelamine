 ...
 */
export function AsciiName({ text, still = false, size = "clamp(4.1px,1.2vw,10.4px)" }:
  { text: string; still?: boolean; size?: string }) {
  ...
  useEffect(() => {
    ...
    if (still || prefersReducedMotion()) { draw(0); return; }
