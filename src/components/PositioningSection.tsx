    ...
    >
      <div className="container mx-auto px-6 text-center z-20">
        <h2 className="font-sans text-headline font-semibold tracking-tighter leading-[1.1]">
          <div className="reveal-text opacity-20 translate-y-8">MSc Strategic Marketing</div>
          <div className="reveal-text opacity-0 translate-y-8 text-accent mt-2">at Imperial College London</div>
        </h2>
        <p className="font-sans text-body text-secondary mt-12 max-w-xl mx-auto opacity-0 reveal-sub">
          Passionate about responsible AI and its impact on global marketing.
        </p>
      </div>
    </section>
  );
